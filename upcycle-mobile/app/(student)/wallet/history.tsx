...
export default function Transaction HistoryScreen() {
  return (
    <ScreenWrapper className="bg-gray-50">
      ...
      <View className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
        <Text className="text-gray-500 text-base">This is the Transaction History screen, fully integrated into the architecture.</Text>
      </View>
    </ScreenWrapper>
  );
}
